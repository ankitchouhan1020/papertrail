...
<p align="center">
  <img src="docs/papertrail-demo.png" alt="Obsidian with Papertrail: note list in the sidebar (titles, excerpts, dates, active row with accent bar), Papertrail footer, and the open note with properties in the editor" width="1200" />
</p>
